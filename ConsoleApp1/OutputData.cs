namespace lab9
{
    internal static class OutputData
    {
        ...
        private static bool CheckDiapasonBelonging(int number, int startNumber, int endNumber) => (startNumber <= number && number <= endNumber);

        private static bool CheckDiapasonBelonging(double number, double startNumber, double endNumber) => (startNumber <= number && number <= endNumber);
        ...
        private static void ReadInput(string message, ref int inputValue)
        {
        ...
        private static void ReadInput(string message, ref double inputValue)
        {
            bool isAppropriateNumber = false;
            do
            {
        ...
        private static int CheckReadIntegerNumber(string message, int startPoint, int endPoint)
        {
            int number = 0;
            do
            {
        ...
        private static double CheckReadDoubleNumber(string message, double startPoint, double endPoint)
        {
            double number = 0;
            do
            {
